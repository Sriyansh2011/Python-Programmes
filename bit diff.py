...
print(" 5 ^ 3=", 5^3, "binary",bin(5^3)[2:],"bits differnet:",bin(5^3).count('1'))
print(" 9 ^ 5=", 9^5,"binary",bin(9^5)[2:],"bits differnet:",bin(9^5).count('1'))
...
print(" ",n,"^7 = binary",bin(n^7)[2:]," differnet bits:", diff,"your guess:",guess)
